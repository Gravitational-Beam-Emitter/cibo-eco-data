import { fetchTrendData, fetchAvailableDates } from "@/lib/api";
...
export default async function BacktestPage({
  ...
  const [trend, dates] = await Promise.all([
